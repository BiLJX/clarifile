        ...
        Rectangle {
            ...
            Item {
                ...
                ColumnLayout {
                   ...
                   // Enhanced Real-time dashboard section
Rectangle {
    color: "#232323"
    radius: 6
    Layout.fillWidth: true
    ...
    ColumnLayout {
        ...
        Text {
            text: qsTr("Manual Organize Dashboard")
            font.pixelSize: 18
            font.bold: true
            color: "white"
        }
        ...
        GridLayout {
            ...
            Rectangle {
                ...
                Column {
                    ...
                    anchors.margins: 8
                    spacing: 4
                    Text { text: "Root Path"; color: "#AAAAAA"; font.pixelSize: 12 }
                    Text { text: pathManager.rootPath; color: "white"; font.pixelSize: 14; elide: Text.ElideRight }
                }
            }
            ...
            Rectangle {
                ...
                Column {
                    ...
                    anchors.margins: 8
                    spacing: 4
                    Text { text: "Destination Path"; color: "#AAAAAA"; font.pixelSize: 12 }
                    Text { text: pathManager.destPath; color: "white"; font.pixelSize: 14; elide: Text.ElideRight }
                }
            }
            ...
            Rectangle {
                ...
                Column {
                    ...
                    anchors.margins: 8
                    spacing: 4
                    Text { text: "Files Organized"; color: "#AAAAAA"; font.pixelSize: 12 }
                    Text { text: pathManager.filesOrganized; color: "white"; font.pixelSize: 14 }
                }
            }
            ...
            Rectangle {
                ...
                Column {
                    ...
                    anchors.margins: 8
                    spacing: 4
                    Text { text: "Last Organized"; color: "#AAAAAA"; font.pixelSize: 12 }
                    Text { text: pathManager.lastOrganizedTime; color: "white"; font.pixelSize: 14 }
                }
            }
        }
    }
