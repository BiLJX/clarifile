...
Button {
    ...
    padding: 14
    background: Rectangle {
        color: "#D32F2F"  // keep Delete button red
        radius: 8
        smooth: true
    }
    onClicked: {
...
RowLayout {
    ...
    junkCleaner.clear()  // <-- This must be implemented and registered properly
}
